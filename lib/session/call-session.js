...
class CallSession extends Emitter {
  ...
  constructor({logger, application, srf, tasks, callInfo, accountInfo, rootSpan, memberId, confName, confUuid}) {
    ...
    // Track AWS transcription results for call-level statistics
...
Duration=${duration} `
 ...
 got response to INFO DTMF digit=${digit} and duration=${duration}`);
  ...
  _configMsEndpoint() {
    ...
    this.ep.addCustomEventListener('aws_transcribe::no_audio_detected', this.awsTranscribeNoAudioDetected.bind(this));
    this.ep.addCustomEventListener('aws_transcribe::vad_detected', this.awsTranscribeVadDetected.bind(this));
  }
...
// Playback event tracking system
